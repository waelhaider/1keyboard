...
function addDirectionButtonsToTop() {
    ...
    directionContainer.style.right = '3px';
    ...
    inputDirectionBtn.style.padding = '3px 1px 3px 1px';
    ...
    inputDirectionBtn.style.fontSize = '10px';
    ...
    textDirectionBtn.style.padding = '3px 1px 3px 1px';
    ...
    textDirectionBtn.style.fontSize = '10px';
    ...
    if (isDefaultBoard) {
      ...
      boards[boardName].forEach(row => {
        ...
        row.forEach(symbol => {
          let td = document.createElement("td");
          td.textContent = symbol;
          td.style.border = ' solid 1px #dbdbdb'; // إزالة الحدود الافتراضية
          ...
          td.style.margin = '1px'; // مسافة بين المربعات
          ...
          td.style.width = '9.7%'; // عرض ثابت للمربع
      ...
      reader.onload = (e) => {
        try {
          ...
          if (data.boardName && data.boardData) {
            ...
            // إضافة اللوحة المسترجعة إلى ترتيب اللوحات إذا لم تكن موجودة
            if (!boardOrder.includes(data.boardName)) {
              boardOrder.push(data.boardName);
              saveBoardOrder();
            }
            saveCustomBoards();
            updateTabsDisplay();
